...
assert.ok(!/field notes/i.test(home), "Articles are labeled plainly");
assert.ok(/Articles/.test(home), "Articles navigation is rendered");
assert.ok(/\$(?:<!-- -->)?40/.test(home), "Rounded first-month discount rendered");
